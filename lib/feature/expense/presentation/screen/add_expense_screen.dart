    ...
    return BlocProvider.value(
      ...
      child: BlocListener<ExpensesBloc, ExpensesState>(
        listener: (context, state) {
          if (state is ExpenseAddedSuccess) {
          ...
          } else if (state is ExpenseOperationError) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
            ...
            GlobalMessageBus.showError(state.message);
          }
        },
...
class _AddExpenseViewState extends State<AddExpenseView> {
  ...
  void initState() {
    super.initState();
    context.read<ExpensesBloc>().add(LoadCategoriesEvent());
  }
          ...
          children: [
            ...
            DropdownButtonFormField<ExpenseCategoryModel>(
              ...
              decoration: InputDecoration(
                ...
                // Increase contentPadding to accommodate the 48px icon
              ...
              // Make the dropdown button itself taller
              isDense: false,
              ...
              items: categories.map((category) {
                return DropdownMenuItem<ExpenseCategoryModel>(
                  ...
                  child: Row(
                    children: [
                      Container(
                        height: 40, // Slightly smaller to fit better
                        width: 40,
